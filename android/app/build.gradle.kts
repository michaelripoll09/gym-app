...
android {
    ...
    buildTypes {
        ...
        release {
            val apiBaseUrl = providers.environmentVariable("GYM_API_BASE_URL").orNull ?: "https://api.gymapp.invalid/api/v1"
            require(apiBaseUrl.startsWith("https://")) { "GYM_API_BASE_URL must use HTTPS for release builds." }
