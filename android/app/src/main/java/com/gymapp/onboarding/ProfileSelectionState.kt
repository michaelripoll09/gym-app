...
data class ProfileSelectionState(val primary: TrainingProfile? = null, val secondaryProfiles: Set<TrainingProfile> = emptySet(), val validationMessage: String? = null) {
