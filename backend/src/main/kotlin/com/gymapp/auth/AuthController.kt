...
class BearerTokenFilter(private val jwt: JwtService) : OncePerRequestFilter() {
    override fun shouldNotFilter(request: HttpServletRequest) = !request.requestURI.startsWith("/api/v1/me") && !request.requestURI.startsWith("/api/v1/workout-plans") && !request.requestURI.startsWith("/api/v1/workout-sessions")
